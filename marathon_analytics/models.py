...
class Result(models.Model):
    """
        Model to represent a single record in the marathon results dataset.Store/represent the data from one runner at the Chicago Marathon 2023.
...
def load_data():
    ...
    filename = '/Users/jackywtk/BU-CS412/marathon_analytics/2023_chicago_results.csv'
    f = open(filename)
